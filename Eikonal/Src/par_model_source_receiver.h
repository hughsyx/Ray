...
void read_parafile(int &dimension, int &nx, int &ny, int &nz, double &dx, double &dy, double &dz, double &xmin, double &ymin, double &zmin, int &invnx, int &invny, int &invnz, double &invdx, double &invdy, double &invdz, double &invxmin, double &invymin, double &invzmin, string &velModel_file, string &source_file, string &receiver_file);
